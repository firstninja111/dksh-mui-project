			...
			<div className="property-box">
				<div className="property-div">
					<div className="share-div">
						<Link href="/velas/velas-apes-club">
							<a className="link-blue">velas</a>
						</Link>
					...
					<ul className="attrs raw">
							...
							<div className="value inline-flex">
								<Link href="/velas/velas-apes-club">
									<a className="link-blue">
										<img
											src="https://s.raregems.io/97/img/chains/velas.svg"
											width={16}
											height={16}
											loading="lazy"
										/>
						...
						<li>
							...
							<div className="value text-white">0xbf0e…B253</div>
						</li>
						<li>
							<div className="name">STANDARD</div>
							<div className="value text-white">ERC721</div>
						</li>
						<li>
							<div className="name">TOKEN ID</div>
							<div className="value text-white">215</div>
						</li>
						<li>
							<div className="name">OWNER</div>
							<div className="value link-blue">0xc501…776F</div>
						</li>
						<li>
					...
					<h2 className="billy-header">
						Attributes
						<span className="text-green m-l-1em">
							Rarity Score: 35
						</span>
					</h2>
					<ul className="attrs raw">
					...
					<h2 className="billy-header with-border-bottom">
						Transfer History
					</h2>
					<span className="hover-blue">
						@ block #14773518: 0x0000…0000 ➞ 0xc501…776F{" "}
					</span>
